(() => {
  ...
  const avatarPreviewImg = root.querySelector("[data-avatar-preview-img]");
  const avatarPreviewLetter = root.querySelector("[data-avatar-preview-letter]");
  const avatarTriggers = root.querySelectorAll("[data-avatar-trigger]");
  const avatarInput = root.querySelector("[data-avatar-input]");
  const avatarActions = root.querySelector("[data-avatar-actions]");
  const avatarSave = root.querySelector("[data-avatar-save]");
  const avatarCancel = root.querySelector("[data-avatar-cancel]");
  const avatarFlash = root.querySelector("[data-avatar-flash]");
  ...
  const avatarModalBackdrop = root.querySelector("[data-avatar-modal-backdrop]");
  const avatarModal = root.querySelector("[data-avatar-modal]");
  const avatarModalCloseButtons = root.querySelectorAll("[data-avatar-modal-close]");
